...
\begin{document}
	...
	\begin{poster}{
		...
		\headerbox{\textbf{4) Resultados numéricos}}{name=nmodo,span=2,column=2,below=abstract}{\footnotesize
			...
			\begin{tikzpicture}
				\node[inner sep=0pt] (graf) at (0,5.7){\includegraphics[scale=.45]{labels.pdf}};
				\node at (-2.5,5) {\footnotesize \textbf{Eléctricos}};
				\node at (3,5) {\footnotesize \textbf{Magnéticos}};
				\node[inner sep=0pt] (graf) at (0,1.5){\includegraphics[scale=.45]{seccTrans.pdf}};
				\node[inner sep=0pt] (graf) at (0,-4.7){\includegraphics[scale=.45]{Resonances.pdf}};
			\end{tikzpicture}
