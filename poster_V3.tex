...
\begin{document}
	...
	\begin{poster}{
		...
		\headerbox{\textbf{5) Conclusiones}}{name=conclusiones,column=2,below=nmodo,span=2}{
			\footnotesize
			\begin{itemize}
				\item[\textcolor{mxpink}{\ding{212}}] La banda de frecuencias en la que las frecuencias de resonancia de los modos eléctricos se espera que se encuentren es $[\omega_{p}/\sqrt{3},\omega_{p}/\sqrt{2}]$. 
